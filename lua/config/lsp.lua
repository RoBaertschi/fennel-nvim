...
local function _2_(ev)
  ...
  do
    ...
    local function _9_(diagnostic)
      _G.assert((nil ~= diagnostic), "Missing argument diagnostic on C:\\Users\\Robin\\AppData\\Local\\nvim\\lua\\config\\lsp.fnl:87")
